...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)){
            ...
            if(mManager!=null)
            {
                mManager.requestPeers(mChannel,multiplayeur.peerListListener);
            }
            ...
            {
                mManager.requestConnectionInfo(mChannel,multiplayeur.connectionInfoListener);

            }else{
                multiplayeur.connectionStatus.setText("Device disconnected");
            }
